(function(module, ns) {
  ...
  Client.prototype = {
     ...
     * Marionette.findElement or Marionette.findElements,
     * the method will continue trying to locate the element
     * for up to timeout ms.
     *
     * This can be useful. For example,
     * the element you’re looking for might not exist immediately,
     * because it belongs to a page which is currently being loaded.
     *
    ...
    screenshot: function screenshot(options, callback) {
      ...
      if (options) {
        cmd.element = options.element.id;
